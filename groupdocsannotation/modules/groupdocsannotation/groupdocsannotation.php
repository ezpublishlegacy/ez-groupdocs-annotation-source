...
function Groupdocsannotation( $row )
{
...
{
return Groupdocsannotation::handleList( $parameters, false );
}
...
return eZPersistentObject::fetchObjectList( Groupdocsannotation::definition(),
